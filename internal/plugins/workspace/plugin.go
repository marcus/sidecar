...
type Plugin struct {
	...
	mainWorktreePollGen int            // Generation counter for main worktree poll loop (td-9233a4)
...
func (p *Plugin) pollAllAgentStatusesNow() tea.Cmd {
	...
	// Also trigger immediate main worktree poll (td-9233a4)
