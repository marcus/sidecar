...
func DefaultBindings() []Binding {
	return []Binding{
		...
		// JJ status context
		{Key: "j", Command: "cursor-down", Context: "jj-status"},
		{Key: "k", Command: "cursor-up", Context: "jj-status"},
		{Key: "down", Command: "cursor-down", Context: "jj-status"},
		{Key: "up", Command: "cursor-up", Context: "jj-status"},
		{Key: "r", Command: "refresh", Context: "jj-status"},
		{Key: "tab", Command: "switch-pane", Context: "jj-status"},
		{Key: "shift+tab", Command: "switch-pane", Context: "jj-status"},
		{Key: "d", Command: "show-diff", Context: "jj-status"},
		{Key: "ctrl+d", Command: "page-down", Context: "jj-status"},
		{Key: "ctrl+u", Command: "page-up", Context: "jj-status"},
		{Key: "O", Command: "open-in-file-browser", Context: "jj-status"},
		{Key: "enter", Command: "open-in-file-browser", Context: "jj-status"},
		{Key: "l", Command: "focus-diff", Context: "jj-status"},
		{Key: "right", Command: "focus-diff", Context: "jj-status"},
		{Key: "h", Command: "focus-list", Context: "jj-status"},
		{Key: "left", Command: "focus-list", Context: "jj-status"},
		{Key: "\\", Command: "toggle-pane", Context: "jj-status"},
		{Key: "g", Command: "go-top", Context: "jj-status"},
		{Key: "G", Command: "go-bottom", Context: "jj-status"},

		// JJ log context
		{Key: "j", Command: "cursor-down", Context: "jj-log"},
		{Key: "k", Command: "cursor-up", Context: "jj-log"},
		{Key: "down", Command: "cursor-down", Context: "jj-log"},
		{Key: "up", Command: "cursor-up", Context: "jj-log"},
		{Key: "r", Command: "refresh", Context: "jj-log"},
		{Key: "tab", Command: "switch-pane", Context: "jj-log"},
		{Key: "shift+tab", Command: "switch-pane", Context: "jj-log"},
		{Key: "d", Command: "show-diff", Context: "jj-log"},
		{Key: "e", Command: "edit-commit", Context: "jj-log"},
		{Key: "enter", Command: "edit-commit", Context: "jj-log"},
		{Key: "ctrl+d", Command: "page-down", Context: "jj-log"},
		{Key: "ctrl+u", Command: "page-up", Context: "jj-log"},
		{Key: "l", Command: "focus-diff", Context: "jj-log"},
		{Key: "right", Command: "focus-diff", Context: "jj-log"},
		{Key: "h", Command: "focus-list", Context: "jj-log"},
		{Key: "left", Command: "focus-list", Context: "jj-log"},
		{Key: "\\", Command: "toggle-pane", Context: "jj-log"},
		{Key: "g", Command: "go-top", Context: "jj-log"},
		{Key: "G", Command: "go-bottom", Context: "jj-log"},
