...
### M4e. Freeze, migrate, flag flip, site docs

- Recall's `sidecar-plugin` subcommand (td-26c2b4, approved) has been revised against the draft once; M4b revised both again; then freeze `sidecar.plugin/v1`.
