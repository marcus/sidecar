...
**Status:** M4c implemented 2026-09-03 (td-40eb97); M4a is ready to start; M4b is gated on the four decisions under [Decisions to confirm](#decisions-to-confirm). Controlling document for milestones M4a, M4b and M4c of [README.md](README.md); M4d (freeze, migrate, flag flip, site docs) stays in the README. **Tracking:** td-f9f007 (epic); per-milestone issues are listed with each milestone.
